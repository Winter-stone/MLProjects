...
def delete_or_keep():
    ...
    for i in categories:
        folder_path = f'dataset/cats_vs_dogs/{i}'
...
def train_test_data():
    ...
    train_generator = datagen.flow_from_directory('dataset/cats_vs_dogs', target_size=(224, 224), batch_size=16,
                                                  class_mode='binary', subset='training')

    valid_generator = datagen.flow_from_directory('dataset/cats_vs_dogs', target_size=(224, 224), batch_size=16,
